...
namespace GoogleARCore.Examples.AugmentedImage
{
    ...
    {
        public AugmentedImage imagen;
        private GameObject baño_2;
        ...
        public void Update()
        {
            if (imagen == null || imagen.TrackingState != TrackingState.Tracking)
            {
                baño_2.SetActive(false);
                return;
            }

            baño_2.transform.localPosition = imagen.CenterPose.position;

            baño_2.transform.rotation = imagen.CenterPose.rotation;

            baño_2.SetActive(true);
